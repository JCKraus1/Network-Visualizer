...
export const THEMES: Record<ThemeName, ThemeConfig> = {
  ...
  arctic: {
    label: 'Clean White', emoji: '☀️', desc: 'Pure white with subtle gray tones',
    primary: '#3b82f6',
    light: true,
    cssVars: {
      '--bg-void': '#f8fafc', '--bg-dark': '#f1f5f9', '--bg-panel': '#ffffff',
      '--bg-card': 'rgba(255,255,255,0.99)', '--bg-surface': 'rgba(249,250,251,0.99)',
      '--border-dim': 'rgba(0,0,0,0.07)', '--border-soft': 'rgba(0,0,0,0.13)', '--border-accent': 'rgba(59,130,246,0.5)',
      '--text-bright': '#111827', '--text-primary': '#374151', '--text-dim': '#9ca3af',
      '--neon-primary': '#3b82f6',
    },
    categories: {
      network:       { label: 'Network',       color: '#2563eb', bg: 'rgba(219,234,254,0.85)'  },
      computer:      { label: 'Computers',     color: '#4338ca', bg: 'rgba(224,231,255,0.85)'  },
      mobile:        { label: 'Mobile',        color: '#7c3aed', bg: 'rgba(237,233,255,0.85)'  },
      entertainment: { label: 'Entertainment', color: '#dc2626', bg: 'rgba(254,226,226,0.85)'  },
      'smart-home':  { label: 'Smart Home',    color: '#059669', bg: 'rgba(209,250,229,0.85)'  },
      peripheral:    { label: 'Peripherals',   color: '#d97706', bg: 'rgba(254,243,199,0.85)'  },
    },
    statusColors: { active: '#059669', online: '#2563eb', idle: '#d97706', offline: '#cbd5e1' },
